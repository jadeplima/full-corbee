...
export const SidebarCollapsibleItem = ({
    ...
    const linkBaseClasses = `transition-colors hover:text-gray-900
    const linkActiveClasses = `text-gray-900
    const linkInActiveClasses = `text-gray-500
    return (
        <li
            className={`relative leading-8 m-0 pl-6 before:block before:w-4 before:h-0 before:absolute before:left-0 before:top-4 before:border-t-2 before:border-t-gray-200 before:-mt-0.5 last:before:bg-white last:before:h-auto last:before:top-4 last:before:bottom-0
        >
            <Tag
                href={href}
                target={target}
            ...
            >
                {(state) => (
                    <div className="overflow-hidden duration-200 transition-all max-h-0">
                        <ul className="relative px-0 pt-2 pb-0 ml-5 before:w-0 before:block before:absolute before:inset-y-0 before:left-0 before:border-l-2 before:border-l-gray-200">
                            {children}
                        </ul>
                    </div>
                )}
    ...
    return (
        <>
            ...
            <aside
                ...
                className={`fixed inset-y-0 z-20 flex flex-col py-4 space-y-6 bg-white shadow-lg ${
                    isSidebarOpen || isSidebarHovered
                        ? 'translate-x-0 w-64'
                        : ''
                } ${
